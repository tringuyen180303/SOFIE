 ...
 * See the <a
 * href="https://github.com/onnx/onnx/blob/main/docs/Operators.md#convtranspose">ONNX
 * documentation</a> for details about the transposed conv layer.
 */
template <typename T> class ROperator_ConvTranspose final : public ROperator {
private:
...
public:
   ...
   */
  ROperator_ConvTranspose(std::string autopad, std::vector<size_t> dilations,
